...
import { Cliente, Paginar, Paginado } from '../others/interfaces';
...
export class ClienteService {
  ...
  listar_activos(oPaginar: Paginar): Observable<Paginado>{
    return this._http.post<Paginado>(`${this.apiService.api_url}/cliente/listaractivos`, oPaginar, this.httpOptionPost)
    .pipe(
